...
if __name__ == "__main__":
    ...
    logger.info("Setting experiment name for mlflow-- logger test")
    ...
    for i, params in enumerate(param_set):
        ...
        with mlflow.start_run(run_name=f"Run {i}"):
            ...
            logger.info(f"Rmese CV Score for{run_name}: {score_cv.mean()}")
    ...
    logger.info(f"best Hyper-paramer: {best_params}")
